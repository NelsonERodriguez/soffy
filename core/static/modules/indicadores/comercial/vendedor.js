...
function drawChartMonths(objData) {
    ...
    const objGraphic = {
        'str_id': 'chartMonths',
        'title': 'Indicador Ventas por Vendedor de los Ultimos Cuatro Meses (según filtro)',
        'subTitle': '',
...
function drawChartWeeks(objData) {
    ...
    const objGraphic = {
        'str_id': 'chartWeeks',
        'title': 'Indicador Ventas por Vendedor de los Ultimas Cuatro Semanas (según filtro)',
        'subTitle': '',
        'objCategories': objCategories,
        'objReal': objReal,
        'objObjective': objObjective,
