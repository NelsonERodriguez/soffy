...
def index(request):
    return render(request, 'reglas_comision/reglas_comision_v2.html')
...
def edit(request):
    ...
    data = {
        ...
        "fecha_inicio": obj_data[0]["fecha_inicio"] if obj_data and obj_data[0]["fecha_inicio"] else '',
    ...
    html = render_to_string('reglas_comision/reglas_comision_edit_v2.html', data)
...
def get_cliente(request, search, union):
    ...
    """ % (str_select, str_busqueda, str_busqueda, str_busqueda)
